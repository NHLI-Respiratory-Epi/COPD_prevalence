...
compress
save copd_prevalence_strat_v2, replace


preserve

collapse (count) valhes_onetwo20* male20* female20* age4020* age5020* age6020* age7020* age8020* region120* region220* region320* region420* region520* region620* region720* region820* region920* region1020*
generate var = "Denominator"

format %9.0g valhes_onetwo20* male20* female20* age4020* age5020* age6020* age7020* age8020* region120* region220* region320* region420* region520* region620* region720* region820* region920* region1020*

reshape long valhes_onetwo male female age40 age50 age60 age70 age80 region1 region2 region3 region4 region5 region6 region7 region8 region9 region10, i(var) j(year)
...
collapse (sum) valhes_onetwo20* male20* female20* age4020* age5020* age6020* age7020* age8020* region120* region220* region320* region420* region520* region620* region720* region820* region920* region1020*
...
foreach var in valhes_onetwo male female age40 age50 age60 age70 age80 region1 region2 region3 region4 region5 region6 region7 region8 region9 region10 {
...
compress
save "`analysis_dir'/copd_prevalence_strat_collapsed_v2", replace


xpose, clear varname
order _varname

export excel "`analysis_dir'/outputs/copd_prevalence_strat_v2.xlsx", replace


use "`analysis_dir'/copd_prevalence_strat_collapsed_v2", clear  //leave on this one as easier to work with
